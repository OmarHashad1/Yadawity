    ...
    <div class="doctor-modal">
        ...
        <div class="modal-header">
            <div class="workshop-header-info">
                <h2 id="sessionTitle" class="workshop-title"></h2>
                    ...
                    <div class="workshop-details">
                        <div class="detail-row">
                            <div class="detail-item">
                                ...
                                <span id="sessionCategory" class="detail-value"></span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Date:</span>
                                <span id="sessionDate" class="detail-value"></span>
                            </div>
                        </div>
                        <div class="detail-row">
                            <div class="detail-item">
                                <span class="detail-label">Time:</span>
                                <span id="sessionTime" class="detail-value"></span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Capacity:</span>
                                <span id="sessionCapacity" class="detail-value"></span>
                            </div>
                        </div>
                        <div class="detail-row">
                            <div class="detail-item">
                                <span class="detail-label">Location:</span>
                                <span id="sessionLocation" class="detail-value"></span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Price:</span>
                                <span id="sessionPrice" class="detail-value"></span>
                            </div>
                        </div>
                        <div class="workshop-description">
                            <span class="detail-label">Description:</span>
                            <p id="sessionDescription" class="detail-value description-text"></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer">
            <button class="book-visit-btn" id="modalBookVisitBtn" onclick="addSessionToCart()">
